      ...
      var render = function render(res) {
        ...
        for (var j = 0, len2 = res.list.length; j < len2; j++) {
          ...
          for (var i = 0, len = data.link.length; i < len; i++) {
            ...
            var minSrc = 'https://raw.githubusercontent.com/liuqi605752176/liuqi605752176.github.io/master/blog_Album/src_photos/' + data.link[i];
			
           // var src = 'https://raw.githubusercontent.com/yourgithub/Blog_Album/master/photos/' + data.link[i];
            var src = 'https://raw.githubusercontent.com/liuqi605752176/liuqi605752176.github.io/master/blog_Album/src_photos/' + data.link[i];
            //var src = 'ftp://167.179.97.55/blog_Album/photos/' + data.link[i];
